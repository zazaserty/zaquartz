...
![[Pasted image 20251022104242.png]]
...
#### Evolution
![[Pasted image 20251022104526.png]]
...
- “Measures are needed across the full life cycle of plastics to address plastic pollution. However, the parties were too far apart. After six rounds of negotiations, the process needs a time out.” - Switzerland.
A lowest denominator text was even tried (voluntary measures with *no teeth*). But the process wasn't going well, even when another improved text was born 6 hours before the end of the negotiations. 80 states took the floor and showed that each party's red lines were incompatible.
...
- What is the *full life cycle* approach?
	- What solutions could be implemented to put an end to the pollution?
		![[Pasted image 20251022113610.png]]
...
### INC-5.2
![[Pasted image 20251022114211.png]]
...
### WWF *must haves*
1. Binding global bans and phase-outs of specific plastic products, including those containing chemicals of concern.
2. Harmonised requirements on product design and systems necessary for a non-toxic circular economy.
3. A comprehensive financing and means of implementation package.
4. Mechanisms to enable strengthening of the treaty over time – including COP voting.
...
- *Where consensus prevents equitable and effective decision-making on issues of global concern, alternatives must be found*.
