## Les colonisations de pays du sud
### Introduction
On appelle les pays non-développés *les Suds*, le sud global, etc. Ceci est quand même anachronique, ce nom a été fait par A.Sauvy pendant la Guerre Froide pour désigner un bloc qui était en dehors des deux blocs opposés:
...
- Dire *en développement* est leur donner une direction, ils ne sont plus en contrôle de ne pas de développer.
- Dire *non-développés* c'est pas très gentil aussi.
...
#### L'Afrique
Elle est composée par zones comme le Mahgreb (Tunisie, Algérie et tout ça, fait partie de l'empire ottoman sauf le Maroc). Il a 12 million d'habitants et est déjà islamisée. Elle est comparable au développement européen. Le Maroc dominait une grande partie du Moyen Orient jusqu'au Mahgreb.

Au sud du Sahara (Afrique sub-saharienne) on a *l'Afrique Noire*. Une région sans écriture, très orale. Elle avait un grand retard technique en général. L'entrée de l'islam n'est pas négative, mais environ au 7ème siécle la traite orientale (on prélève des populations comme esclaves dans le monde musulman). La trajectoire de l'Afrique a été impactée avec un retard à cause de cela.
#### Moyen-Orient
...
#### Asie
La région des grandes civilisations, la plus grande du monde depuis quelques temps. L'Inde et la Chine ont toujours été très peuplées. L'Inde est la terre des épices, des cachemires, etc. Cette richesse va être exposée par Marco Polo et va intéresser les colons. Cette région était dominé par les Mongols (islamistes) du 16ème au début du 18ème. L'Inde prend de la vitesse avec le cotton (1ère du monde) par rapport a GB.
...
Les terres se concentrent et sont exploitées. Il y aura des réformes agraires mais elles ne marcheront pas. Au Mexique, par exemple elle était incomplète. Ceci nous a donné une distribution actuelle inéquitable.
#### Amérique du Nord
...
La Lybie était aussi colonisée (par les italiens) mais a obtenu son indépendance en 1951 bien avant que sa réserve de pétrole puisse être découverte ou exploitée par les colonisateurs.
...
Les gents étaient enlevés de leur villages pour être *intégrés* dans les plantations, etc. Beaucoup mourraient en attendant dans les ports africains ou même dans les bateaux. Les côtes de l'Afrique étaient l'interface pour accéder au commerce triangulaire.
![[Pasted image 20241030112237.png]]
La communication entre familles, nourriture, etc; dans les bateaux était horrible. Ceux qui résistaient devaient souffrir plus dans les plantations. Les femmes étaient souvent violées pour produire plus de main d'oeuvre.

Ce procès devient plutôt industriel, avec un caractère de masse; de l'autre coté de l'Atlantique on absorbe beaucoup de main d'oeuvre pour les mines et plantations. On a besoin de pas mal d'esclaves.
##### Flux de la traite
Départs :
...
#### Conséquences
Les pays du Sud on resté dans le secteur primaire, et l'Europe a continué avec ses produits manufacturés. Même si l'époque des colons est finie, cette dynamique est restée présente. Certains pays comme l'Argentine ont réussi a briser cette structure- en se transformant en puissance-, mais pendant peu de temps.

On pourrait même dire que le développement européen s'est fait en sacrifiant l'africain (et celui d'autres continents non-développes).
...
Ce *pacte* - qui n'est qu'un ensemble de pratiques menées par les colons- a eu des conséquences graves sur les colonies:
